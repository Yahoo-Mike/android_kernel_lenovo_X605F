...
#if FTS_GESTURE_EN
unsigned int gesture_enable = 0;	/*zhangchaofan@wind-mobi.com add for XXX 2018-04-16  begin*/

/******************************************************************************
* Private constant and macro definitions using #define
*****************************************************************************/
/* modify begin by zhangchaofan@wind-mobi.com, 2018-04-17 */
	/*double tap */
#define DOUBLE_TAP	0x270
	
	/*swipe  */
#define SWIPE_X_LEFT	0x280
#define SWIPE_X_RIGHT	0x281
#define SWIPE_Y_UP	0x282
#define SWIPE_Y_DOWN	0x283
	
	/*unicode */
#define UNICODE_E	0x290
#define UNICODE_C	0x291
#define UNICODE_W	0x292
#define UNICODE_M	0x293
#define UNICODE_O	0x294
#define UNICODE_S	0x295
#define UNICODE_V_DOWN	0x296
#define UNICODE_Z	0x297
#define UNICODE_L	0x298
...
/* modify end by zhangchaofan@wind-mobi.com, 2018-04-17 */
/*****************************************************************************
...
static void fts_gesture_report(struct input_dev *input_dev, int gesture_id)
{
	...
	if (gesture_enable == 1) {
	    switch (gesture_id) {
	    case GESTURE_LEFT:
	        gesture = SWIPE_X_LEFT;
	        break;
	    case GESTURE_RIGHT:
	        gesture = SWIPE_X_RIGHT;
	        break;
	    case GESTURE_UP:
	        gesture = SWIPE_Y_UP;
	        break;
...
/* modify begin by zhangchaofan@wind-mobi.com, 2018-04-17 */
    ...
    input_set_capability(input_dev, EV_KEY, DOUBLE_TAP);
    input_set_capability(input_dev, EV_KEY, SWIPE_Y_UP);
    input_set_capability(input_dev, EV_KEY, SWIPE_Y_DOWN);
    input_set_capability(input_dev, EV_KEY, SWIPE_X_LEFT);
    input_set_capability(input_dev, EV_KEY, SWIPE_X_RIGHT);
    input_set_capability(input_dev, EV_KEY, UNICODE_O);
    input_set_capability(input_dev, EV_KEY, UNICODE_E);
    input_set_capability(input_dev, EV_KEY, UNICODE_M);
    input_set_capability(input_dev, EV_KEY, UNICODE_L);
    input_set_capability(input_dev, EV_KEY, UNICODE_W);
    input_set_capability(input_dev, EV_KEY, UNICODE_S);
    input_set_capability(input_dev, EV_KEY, UNICODE_V_DOWN);
    input_set_capability(input_dev, EV_KEY, UNICODE_Z);
    input_set_capability(input_dev, EV_KEY, UNICODE_C);

    __set_bit(SWIPE_X_RIGHT, input_dev->keybit);
    __set_bit(SWIPE_X_LEFT, input_dev->keybit);
    __set_bit(SWIPE_Y_UP, input_dev->keybit);
    __set_bit(SWIPE_Y_DOWN, input_dev->keybit);
    __set_bit(DOUBLE_TAP, input_dev->keybit);
    __set_bit(UNICODE_O, input_dev->keybit);
    __set_bit(UNICODE_E, input_dev->keybit);
    __set_bit(UNICODE_M, input_dev->keybit);
    __set_bit(UNICODE_W, input_dev->keybit);
    __set_bit(UNICODE_L, input_dev->keybit);
    __set_bit(UNICODE_S, input_dev->keybit);
    __set_bit(UNICODE_V_DOWN, input_dev->keybit);
    __set_bit(UNICODE_C, input_dev->keybit);
    __set_bit(UNICODE_Z, input_dev->keybit);
