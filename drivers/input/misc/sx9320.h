...
#define SX9320_WHOAMI_VALUE				0x22
...
/* fengnan@wind-mobi.com add 20180410 begin */
static struct smtc_reg_data sx9320_i2c_reg_setup[] = {
//Interrupt and config
	{
		.reg = SX9320_IRQ_ENABLE_REG,	//0x05
		.val = 0x60,					// Enavle Close and Far -> enable compensation interrupt
	},
	{
	...
	},
	{
		...
		.val = 0x01,       //Analog Range(ph0/1) : Small
	},
	{
	...
	},
	{
		...
		.val = 0x00,       // CS2:HZ CS1:Input CS0 :HZ
	},
	{
		.reg = SX9320_AFE_PH1_REG,     //0x29
		.val = 0x26,       // CS2:Input CS1:HZ Shield CS0 :HZ
	},
	{
		.reg = SX9320_AFE_PH2_REG,   //0x2A
		.val = 0x1a,       //CS2:HZ CS1:HZ CS0 :HZ  
	},
	{
	...
	//--------Sensor enable
	{
		...
		.val = 0x24,//0x26,       //enable PH2    //fengnan@wind-mobi.com changed 20180523
	},
};
...
static struct _buttonInfo psmtcButtons[] = {
	...
	{
		.keycode = KEY_SAR_LTE_CS1,  //fengnan@wind-mobi.com add at  20180425
		.mask = SX9320_PROXSTAT_PH1_FLAG,
	},
	{
		.keycode = KEY_SAR_LTE_CS2,  //fengnan@wind-mobi.com add at  20180425
...
//fengnan@wind-mobi.com 20180410 end
