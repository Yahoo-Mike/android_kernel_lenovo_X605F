...
struct fpc1020_data {
	...
	int irq_gpio;
	int rst_gpio;
	int power_en_gpio; /* caisijing@wind-mobi.com 20180309 add */
...
static int fpc1020_probe(struct platform_device *pdev)
{
	...
	if (rc)
		goto exit;
	/* caisijing@wind-mobi.com 20180309 add start */
	rc = fpc1020_request_named_gpio(fpc1020, "fpc,power_en",
			&fpc1020->power_en_gpio);
	if (rc)
		goto exit;
	/* caisijing@wind-mobi.com 20180309 add end */
	...
	if (rc)
		goto exit;
	/* caisijing@wind-mobi.com 20180309 add start */
	rc = select_pin_ctl(fpc1020, "fpc1020_pwr_enable");
	if (rc)
		goto exit;
	gpio_set_value(fpc1020->power_en_gpio, 1);
