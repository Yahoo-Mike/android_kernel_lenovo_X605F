...
ifeq ($(findstring p10,$(TARGET_PRODUCT)), p10)
    $(warning "---p10")
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-boe-ft8201-1080p-video-p10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-boe-ft8201-1080p-video.dtsi)
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-inx-ft8201-1080p-video-p10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-inx-ft8201-1080p-video.dtsi)
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/msm8953_p10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/msm8953.dtsi)
else
    $(warning "---m10")
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-boe-ft8201-1080p-video-m10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-boe-ft8201-1080p-video.dtsi)
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-inx-ft8201-1080p-video-m10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/dsi-panel-inx-ft8201-1080p-video.dtsi)
    $(shell cp -f kernel/msm-3.18/arch/arm/boot/dts/qcom/msm8953_m10.dtsi kernel/msm-3.18/arch/arm/boot/dts/qcom/msm8953.dtsi)
endif
